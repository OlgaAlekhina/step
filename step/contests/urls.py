...
from .views import (
    ...
    UserTaskView, ContestTasksView, ConfigsView, CreateConfigView
)
...
urlpatterns = [
    ...
    path('configs/<str:config_type>/', ConfigsView.as_view(), name='get_configs'),
    path('configs/', CreateConfigView.as_view(), name='create_configs'),
]
